...
# ImGui
set(IMGUI_DIR ${CMAKE_CURRENT_SOURCE_DIR}/thirdparty/imgui-1.91.1)
set(IMGUI_SOURCES
        ${IMGUI_DIR}/imgui.cpp
...
# ImGui-SFML
add_subdirectory(${CMAKE_CURRENT_SOURCE_DIR}/thirdparty/imgui-sfml-2.6.1)

# RapidCSV
add_subdirectory(${CMAKE_CURRENT_SOURCE_DIR}/thirdparty/rapidcsv-8.50)

# Tracy profiler
add_subdirectory(${CMAKE_CURRENT_SOURCE_DIR}/thirdparty/tracy)

# Set properties for imgui and ImGui-SFML
set_target_properties(imgui ImGui-SFML PROPERTIES CXX_STANDARD 20 CXX_STANDARD_REQUIRED YES)